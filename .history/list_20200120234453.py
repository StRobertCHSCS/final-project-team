...
def on_draw():
    ...
    for i in range (1, 4, -1):
        my_button = [i*100, i*200, i*150, i*50, button_text[i]]  # x, y, width, height
        button_text.append(my_button)
        arcade.draw_xywh_rectangle_filled(my_button[0],
                                        my_button[1],
                                        my_button[2],
                                        my_button[3],
                                        arcade.color.BLACK)
        arcade.draw_text(my_button[4], my_button[0]//2, my_button[1]//2, arcade.color.BLACK, 10, font_name= "comic sans")
