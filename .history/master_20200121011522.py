...
def start_screen():
    ...
    for i in range (0, 4):
        ...
        arcade.draw_text(buttons[i][4], buttons[i][0] + (buttons[i][2] // 2), buttons[i][1] + (buttons[i][3] // 2), arcade.color.YELLOW, 10, font_name= "comic sans", anchor_x="center", anchor_y="center")
    if show_text:
            print("click")
