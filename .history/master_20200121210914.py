...
for x in range (1, 5, 2):
    for y in range (1, 5, 2):
        death_options = [x*(SCREEN_WIDTH//4) - 150, y*(SCREEN_HEIGHT//4) - 150, 150, 150, death_button_text[text_num]]  # x, y, width, height
...
def death_screen():
    global dead_button, death_button_text
    arcade.draw_text("You died", SCREEN_WIDTH//2, SCREEN_HEIGHT//2, arcade.color.WHITE, 25, font_name='calibri')
    for i in range (0, 4):
