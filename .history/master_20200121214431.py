...
def death_screen():
    global dead_button, death_button_text, colour_count
    
    red = 255
    blue = 0
    green = 0
    while (red == 255 and blue == 0 and green == 0):
        blue += 1
        if (red == 255 and blue == 255 and green == 0):
            red -= 1
            if (red == 0 and blue == 255 and green == 0):
                green += 1
                if (red == 0 and blue == 255 and green == 255):
                    blue -= 1
                    if (red == 0 and blue == 0 and green == 255):
                        red += 1
