...
def death_screen():
    ...
    arcade.draw_text("You died rip lol", SCREEN_WIDTH//2, SCREEN_HEIGHT//2, (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)),
                    50, font_name='calibri', bold = True, anchor_x="center", anchor_y="center", rotation = rotate += 10)
    for i in range (0, 4):
