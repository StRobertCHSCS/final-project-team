...
def death_screen():
    ...
    for i in range (100):
        arcade.draw_text("You died rip lol", random.randint(50, SCREEN_WIDTH//2), random.randint(50, SCREEN_HEIGHT//2), (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)),
                        50, font_name='calibri', bold = True, anchor_x="center", anchor_y="center", rotation = i)
    for i in range (0, 4):
