...
def high_score_page():
    global high_score, scored
    arcade.draw_text("The high score is " + high_score(scored), SCREEN_WIDTH //2, SCREEN_HEIGHT // 2,
...
def on_mouse_press(x, y, button, modifiers):
    ...
    if page == 2:
        ...
        if (x > dead_button[0][0] and x < dead_button[0][0] + dead_button[0][2] and
            ...
            restart()
            print("try again")
        if (x > dead_button[1][0] and x < dead_button[1][0] + dead_button[1][2] and
