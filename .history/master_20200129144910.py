...
def stop_watch():
    ...
    arcade.draw_text(f"times: {minute:02d}:{second:02d}", 75, SCREEN_HEIGHT - 50, (red, green, blue),
                    25, font_name='calibri', bold = True, anchor_x="center", anchor_y="center")
    arcade.draw_text(time.asctime(times.localtime(times.time())), 75, SCREEN_HEIGHT - 100, (red, green, blue),
                    25, font_name='calibri', bold = True, anchor_x="center", anchor_y="center")
...
def high_score_page():
    ...
    arcade.draw_text("The high score is " + str(high_score),dead_button[3][0], dead_button[3][1],
                            arcade.color.BLACK, 50, font_name='calibri', anchor_x="center", anchor_y="center")
