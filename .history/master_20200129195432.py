...
def start_screen():
    ...
    if easy == False:
        arcade.draw_xywh_rectangle_filled(alive_button[5][0],
                                        alive_button[5][1],
                                        alive_button[5][2],
                                        alive_button[5][3],
                                        arcade.color.RED)
        ...
        arcade.draw_xywh_rectangle_filled(alive_button[5][0],
                                            ...
                                            alive_button[5][3],
                                            arcade.color.GREEN)
    arcade.draw_text(alive_button[5][4], alive_button[5][0] + (alive_button[5][2] // 2), alive_button[5][1] + (alive_button[5][3] // 2),
