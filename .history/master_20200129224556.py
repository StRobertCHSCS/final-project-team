...
def stop_watch():
    global times, second, minute, SPEED
    global local_time
...
def high_score_page():
    ...
    arcade.draw_text("The high score is " + str(high_score) + "\n Your score is " + str(score),dead_button[3][0], dead_button[3][1],
                            arcade.color.GREEN, 50, font_name='calibri', bold=True, anchor_x="center", anchor_y="center")
...
def on_mouse_press(x, y, button, modifiers):
    ...
    if page == 2:
        ...
        elif (x > dead_button[1][0] and x < dead_button[1][0] + dead_button[1][1] and
                    y > dead_button[1][1] and y < dead_button[1][2] + dead_button[1][3]):
            print("exit")
            arcade.close_window()
