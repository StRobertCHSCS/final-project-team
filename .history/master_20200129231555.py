...
def stop_watch():
    ...
    arcade.draw_text(f"Time played this session: {minute:02d}:{second:02d}", 25, SCREEN_HEIGHT - 50, (red, green, blue),
...
def death_screen():
    ...
    arcade.draw_text("The high score is " + str(high_score) + "\n  Your score is " + str(score), 
                    (dead_button[1][0]), 2*(dead_button[0][1]),
                    (red, green, blue), 50, font_name='calibri', bold=True)
