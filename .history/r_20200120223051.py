...
[docs]    def draw_color_theme(self):
...
[docs]    def draw_texture_theme(self):
        if self.pressed:
...
[docs]    def check_mouse_press(self, x, y):
...
[docs]    def check_mouse_release(self, _x, _y):
        if self.pressed:
            self.on_release()



[docs]class SubmitButton(TextButton):
...
[docs]    def on_mouse_press(self, x, y, _button, _modifiers):
        for button in self.button_list:
            button.check_mouse_press(x, y)


[docs]    def on_mouse_release(self, x, y, _button, _modifiers):
        for button in self.button_list:
...
[docs]    def color_theme_draw(self):
        if self.highlighted:
...
[docs]    def texture_theme_draw(self):
        arcade.draw_texture_rectangle(self.x, self.y, self.width, self.height, self.texture)
        self.draw_text()
...
[docs]    def update(self, _delta_time, text, symbol, cursor_index):
        self.text = text
        self.symbol = symbol
...
[docs]    def update(self, delta_time, key):
...
[docs]    def check_mouse_release(self, x, y):
...
[docs]    def add_button_textures(self, normal, hover="", clicked="", locked=""):
...
[docs]    def add_window_texture(self, window_texture):
        self.window_texture = arcade.load_texture(window_texture)


[docs]    def add_menu_texture(self, menu_texture):
        self.menu_texture = arcade.load_texture(menu_texture)


[docs]    def add_dialogue_box_texture(self, dialogue_box_texture):
        self.dialogue_box_texture = arcade.load_texture(dialogue_box_texture)


[docs]    def add_text_box_texture(self, text_box_texture):
        self.text_box_texture = arcade.load_texture(text_box_texture)


[docs]    def set_font(self, font_size, font_color, font_name=('Calibri', 'Arial')):
        self.font_color = font_color
        self.font_size = font_size
        self.font_name = font_name